...
function onCreatePost()
	...
	makeLuaSprite('sanshealthbar', 'zhealthbar/sanshealthbar', 320, 629.55);
	addLuaSprite('sanshealthbar', true)
	setObjectCamera('sanshealthbar', "hud")	
	setObjectOrder('sanshealthbar', 1)
	setLuaSpriteScrollFactor('sanshealthbar', 5, 5);
	scaleObject('sanshealthbar', 1, 1.03)    
	...
	if downscroll then
	setProperty('sanshealthbar.y', 68)
end	
end
